...
<footer class="footer-section">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 mb-50">
                        <div class="footer-widget">
                            ...
                            <div class="footer-text mb-25">
                                <p>Đăng Ký Để Nhận Thêm Nhiều Tin Tức Từ Chúng Tôi.</p>
                            </div>
                            <div class="subscribe-form">
                                <form action="#">
                                    <input type="text" placeholder="Email">
                                    <button><i class="fa fa-paper-plane" style="color: #ffffff;"></i></button>
                                </form>
                            </div>
                        </div>
                    </div>
    ...
    <script>
      ...
      chatbox.setAttribute("page_id", "191828407338890");
